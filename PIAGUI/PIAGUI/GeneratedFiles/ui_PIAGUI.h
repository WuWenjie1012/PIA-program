...
public:
    ...
    QLabel *medit;
    QLineEdit *DataNumDisplay;
    QLabel *medit_2;
    QLabel *label_4;
    QLineEdit *CtlNumDisplay;
    QLineEdit *FittingErrorDisplay;
    ...
    void setupUi(QMainWindow *PIAGUIClass)
    {
        ...
        font.setWeight(75);
        medit->setFont(font);
        DataNumDisplay = new QLineEdit(widget);
        DataNumDisplay->setObjectName(QStringLiteral("DataNumDisplay"));
        DataNumDisplay->setEnabled(false);
        DataNumDisplay->setGeometry(QRect(110, 0, 91, 20));
        QFont font1;
        font1.setPointSize(10);
        DataNumDisplay->setFont(font1);
        DataNumDisplay->setStyleSheet(QStringLiteral("background:transparent;border-width:0;border-style:outset"));
        ...
        CtlNumDisplay = new QLineEdit(widget);
        CtlNumDisplay->setObjectName(QStringLiteral("CtlNumDisplay"));
        CtlNumDisplay->setEnabled(false);
        CtlNumDisplay->setGeometry(QRect(110, 20, 101, 20));
        CtlNumDisplay->setFont(font1);
        CtlNumDisplay->setStyleSheet(QStringLiteral("background:transparent;border-width:0;border-style:outset"));
        FittingErrorDisplay = new QLineEdit(widget);
        FittingErrorDisplay->setObjectName(QStringLiteral("FittingErrorDisplay"));
        FittingErrorDisplay->setEnabled(false);
        FittingErrorDisplay->setGeometry(QRect(120, 40, 121, 20));
        FittingErrorDisplay->setFont(font1);
        FittingErrorDisplay->setStyleSheet(QStringLiteral("background:transparent;border-width:0;border-style:outset"));
        medit->raise();
        medit_2->raise();
        label_4->raise();
        FittingErrorDisplay->raise();
        CtlNumDisplay->raise();
        DataNumDisplay->raise();
        PIAButton = new QRadioButton(centralWidget);
        PIAButton->setObjectName(QStringLiteral("PIAButton"));
        PIAButton->setGeometry(QRect(690, 280, 121, 16));
        ...
        LSPIAButton->setGeometry(QRect(690, 310, 89, 16));
        ...
        TargetError->setGeometry(QRect(860, 200, 113, 20));
        label_3 = new QLabel(centralWidget);
        label_3->setObjectName(QStringLiteral("label_3"));
        label_3->setGeometry(QRect(690, 200, 121, 16));
        ...
        CtlNum = new QLineEdit(centralWidget);
        CtlNum->setObjectName(QStringLiteral("CtlNum"));
        CtlNum->setEnabled(true);
        CtlNum->setGeometry(QRect(860, 170, 113, 20));
        ...
        label_7->setGeometry(QRect(690, 250, 121, 16));
        label_7->setFont(font);
        FairLSPIAButton = new QRadioButton(centralWidget);
        FairLSPIAButton->setObjectName(QStringLiteral("FairLSPIAButton"));
        FairLSPIAButton->setGeometry(QRect(690, 340, 89, 16));
        FairLSPIAButton->setFont(font1);
    ...
    void retranslateUi(QMainWindow *PIAGUIClass)
    {
        ...
        DataNumDisplay->setText(QString());
        ...
        CtlNumDisplay->setText(QString());
        FittingErrorDisplay->setText(QString());
        ...
        CtlNum->setText(QApplication::translate("PIAGUIClass", "200", Q_NULLPTR));
        SetCtlNum->setText(QApplication::translate("PIAGUIClass", "Set", Q_NULLPTR));
        label_7->setText(QApplication::translate("PIAGUIClass", "Fitting Method", Q_NULLPTR));
        FairLSPIAButton->setText(QApplication::translate("PIAGUIClass", "FairLSPIA", Q_NULLPTR));

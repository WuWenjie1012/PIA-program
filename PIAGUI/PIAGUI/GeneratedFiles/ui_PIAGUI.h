...
public:
    ...
    void setupUi(QMainWindow *PIAGUIClass)
    {
        ...
        radioButton->setGeometry(QRect(690, 420, 121, 16));
        QFont font;
        ...
        radioButton_2->setGeometry(QRect(690, 440, 89, 16));
    ...
    void retranslateUi(QMainWindow *PIAGUIClass)
    {
        ...
        radioButton->setText(QApplication::translate("PIAGUIClass", "PIA", Q_NULLPTR));
        ...
        radioButton_2->setText(QApplication::translate("PIAGUIClass", "LSPIA", Q_NULLPTR));
